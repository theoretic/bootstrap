...
$splitter=(strstr($includePath,'\\'))? '\\' : '/';
$parts=explode($splitter,$includePath);
array_pop($parts);
$includePath=implode($splitter,$parts);

//require_once(dirname(__FILE__).'/../script/SassScriptParser.php');
//require_once(dirname(__FILE__).'/../renderers/SassRenderer.php');

require_once($includePath.'/script/SassScriptParser.php');
require_once($includePath.'/renderers/SassRenderer.php');
